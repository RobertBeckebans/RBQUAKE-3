...
=================
*/
void UI_ConfirmMenu_Style( const char* question, int style, void ( *draw )(), void ( *action )( qboolean result ) )
{
...
=================
*/
void UI_ConfirmMenu( const char* question, void ( *draw )(), void ( *action )( qboolean result ) )
{
