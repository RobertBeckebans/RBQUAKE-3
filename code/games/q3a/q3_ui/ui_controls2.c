...
static configcvar_t	 g_configcvars[] = { { "cl_run", 0, 0 },
	 { "m_pitch", 0, 0 },
	 { "cg_autoswitch", 0, 0 },
	 { "sensitivity", 0, 0 },
	 { "in_joystick", 0, 0 },
...
static menucommon_s* g_movement_controls[] = { ( menucommon_s* )&s_controls.alwaysrun,
...
static void Controls_UpdateModel( int anim )
{
	...
	UI_PlayerInfo_SetInfo(
		&s_controls.playerinfo, s_controls.playerLegs, s_controls.playerTorso, s_controls.playerViewangles, s_controls.playerMoveangles, s_controls.playerWeapon, s_controls.playerChat );
}
...
static void Controls_InitWeapons( void )
{
	...
	for( item = bg_itemlist + 1; item->classname; item++ )
	{
		...
		trap_R_RegisterModel( item->models[0] );
	}
}
